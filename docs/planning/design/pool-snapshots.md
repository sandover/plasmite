<!--
Purpose: Describe the snapshot files produced during validation/corruption detection and how to interpret them.
Exports: N/A (documentation).
Role: Design note for maintainers.
Invariants: Snapshot semantics must match the validator implementation.
-->
