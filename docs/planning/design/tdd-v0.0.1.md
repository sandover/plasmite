<!--
Purpose: Describe the storage format, concurrency model, and recovery invariants for the v0 pool implementation.
Exports: N/A (documentation).
Role: Design/TDD notes for maintainers; complements the normative spec.
Invariants: This doc is explanatory and may evolve; the normative CLI contract lives in `spec/v0/SPEC.md`.
-->
...
- Chunking and out-of-band blob references are **post-v0** roadmap items (see `docs/planning/roadmap.md`).
