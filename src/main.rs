...
//! Invariants: Commands emit JSON on stdout when stdout is non-interactive; some commands emit
//! human-friendly output on interactive terminals (stdout TTY).
//! Invariants: Errors are JSON on stderr.
